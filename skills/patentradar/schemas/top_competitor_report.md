...
| `excluded_candidates` | CandidateEvidence[] | ✅ | 失格候选（disqualified=true），可为空 |
...
| `product_version` | string | ✅ | 产品介绍（1-2 句自然语言）|
...
- 失格的候选放进 `excluded_candidates`，不要放进 `top_competitors`
